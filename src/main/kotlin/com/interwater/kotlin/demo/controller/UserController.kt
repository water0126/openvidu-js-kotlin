...
class UserController(private val userRepository: UserRepository) {
    ...
    @ResponseBody
    fun register(@RequestBody user: User): ResponseEntity<Any> { // You should hash users' passwords
    ...
    /**
     * test for registration user role
     */
    @PostMapping("/user/test")
    @ResponseBody
    fun test(@RequestBody user: User): ResponseEntity<Any> { // You should hash users' passwords
